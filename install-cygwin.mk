...
$(PREFIX)/bin/$(TARGET)-as: build-binutils/Makefile
	cd build-binutils && $(MAKE) -j 2
	cd build-binutils && $(MAKE) -j 2 install
...
$(PREFIX)/bin/$(TARGET)-gcc: build-gcc/Makefile
	...
	cd build-gcc && $(MAKE) -j 2 all-gcc
	cd build-gcc && $(MAKE) -j 2 all-target-libgcc
